...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script type='text/javascript' src="{{asset('clinic_frontend/js/jquery.js')}}"></script>
    <script type='text/javascript' src="{{asset('clinic_frontend/js/jquery.collapsible.min.js')}}"></script>
    <script type='text/javascript' src="{{asset('clinic_frontend/js/swiper.min.js')}}"></script>
    <script type='text/javascript' src="{{asset('clinic_frontend/js/jquery.countdown.min.js')}}"></script>
    <script type='text/javascript' src="{{asset('clinic_frontend/js/circle-progress.min.js')}}"></script>
