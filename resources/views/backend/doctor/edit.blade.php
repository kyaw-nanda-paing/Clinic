...
<form class="col-lg-11" method="post" action="{{route('doctor.update',$doctors->id)}}" enctype="multipart/form-data">@csrf
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputName" name="name" value="{{($doctors->user->name)}}">
      @if ($errors->any()) 
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="email" class="form-control" id="inputEmail" name="email" value="{{$doctors->user->email}}">
      @if ($errors->any()) 
